...
class ChampionsViewModel : ViewModel(), ChampionsListener {
    ...
    val onSuccessGetChampionsListLiveData: MutableLiveData<Champions> = MutableLiveData()
    ...
    override fun onSuccessGetChampionsList(champions: Champions?) {
        onSuccessGetChampionsListLiveData.postValue(champions)
    }
}